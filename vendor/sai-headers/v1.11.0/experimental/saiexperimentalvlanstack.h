 ...
 *
 * @file    saiexperimentalvlanstack.h
 *
 * @brief   This module defines vlan extensions of the Switch Abstraction Interface (SAI)
 */

#if !defined (__SAIEXPERIMENTALVLANSTACK_H_)
#define __SAIEXPERIMENTALVLANSTACK_H_
...
typedef enum _sai_vlan_stack_attr_t
{
    ...
    /**
     * @brief Original Vlan ID of the inner or outer
     * The action will perform on the packets whose vlan tag match the corresponding vlan ID
     *
     * @type sai_uint16_t
     * @flags MANDATORY_ON_CREATE | CREATE_ONLY
     * @isvlan true
    ...
    /**
     * @brief Applied Vlan ID of the inner or outer
...
#endif /** __SAIEXPERIMENTALVLANSTACK_H_ */
