...
fn next_words(mode: CliMode, path: &[&str]) -> &'static [&'static str] {
    match (mode, path) {
        ...
        (CliMode::Operational, ["show", "system"]) => &["users", "commits", "image"],
        (CliMode::Operational, ["show", "logging"]) => &[NUM],
        ...
        (CliMode::Config, ["set" | "delete", "system", "logging"]) => &["host", "level"],
        (CliMode::Config, ["set" | "delete", "system", "logging", "host"]) => &[ANY],
        (CliMode::Config, ["set", "system", "logging", "host", ANY]) => &["port", "protocol"],
        (CliMode::Config, ["set", "system", "logging", "host", ANY, "port"]) => &[NUM],
        (CliMode::Config, ["set", "system", "logging", "host", ANY, "protocol"]) => &["udp", "tcp"],
        (CliMode::Config, ["set", "system", "logging", "level"]) => &[
            "emergencies",
            "alerts",
            "critical",
            "errors",
