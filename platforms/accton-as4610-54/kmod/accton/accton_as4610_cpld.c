...
#include "accton_as4610.h"

/*
 * Hemlock local port. Upstream targets Linux 3.2-4.9; this builds on
 * 6.1 (the AS4610 image kernel) and 6.12 (Debian trixie, what
 * build/kmod-smoke.sh compile-tests against). See kmod/README.md.
 */
#if LINUX_VERSION_CODE < KERNEL_VERSION(6, 1, 0)
#error "accton_as4610 platform modules require Linux 6.1 or newer"
#endif
...
static int as4610_54_cpld_do_probe(struct i2c_client *client,
			 const struct i2c_device_id *id)
{
	...
	data->type = id ? id->driver_data : as4610_54_cpld;
...
/* The i2c core dropped the id argument from .probe in 6.3 (adding
 * i2c_client_get_device_id() to recover it) and renamed .probe_new back
 * to .probe in 6.6. Before 6.3 the two-argument .probe is used as-is. */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(6, 3, 0)
static int as4610_54_cpld_probe(struct i2c_client *client)
{
	return as4610_54_cpld_do_probe(client, i2c_client_get_device_id(client));
}
#endif

/* .remove has returned void since 6.1 (the floor asserted above). */
static void as4610_54_cpld_remove(struct i2c_client *client)
{
    struct as4610_54_cpld_data *data = i2c_get_clientdata(client);
...
static struct i2c_driver as4610_54_cpld_driver = {
	...
	.probe_new	= as4610_54_cpld_probe,
#else
	.probe		= as4610_54_cpld_do_probe,
#endif
