...
static void as4610_fan_do_remove(struct platform_device *pdev)
{
...
/* platform_driver .remove went from int to void in 6.11. */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(6, 11, 0)
static void as4610_fan_remove(struct platform_device *pdev)
{
	as4610_fan_do_remove(pdev);
}
#else
